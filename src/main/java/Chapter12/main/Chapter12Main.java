...
import Chapter12.jdbc.JdbcExample;
...
//		System.out.println(result*0.88);
	...
	public static void tesSpring() {
		ApplicationContext ctx = new ClassPathXmlApplicationContext("chapter12.config/spring-cfg.xml");
...
//		});
	...
	public static void testSqlSessionTemplate() {
		...
		sqlSessionTemplate.insert("Chapter12.mapper.RoleMapper.insertRole", role);
		Long id = role.getId();
		sqlSessionTemplate.selectOne("Chapter12.mapper.RoleMapper.getRole", id);
		role.setNote("update_sqlSessionTemplate");
		sqlSessionTemplate.update("Chapter12.mapper.RoleMapper.updateRole", role);
		sqlSessionTemplate.delete("Chapter12.mapper.RoleMapper.deleteRole", id);
	}
